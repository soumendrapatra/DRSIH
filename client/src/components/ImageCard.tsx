  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square bg-[var(--color-bg-base)] overflow-hidden border-b border-[var(--color-border)] flex flex-col items-center justify-center gap-4">
        ...
        {/* Corner markers */}
        <div className="absolute top-2 left-2 border-t border-l w-3.5 h-3.5 border-[var(--color-border-hi)]" />
        <div className="absolute top-2 right-2 border-t border-r w-3.5 h-3.5 border-[var(--color-border-hi)]" />
        <div className="absolute bottom-2 left-2 border-b border-l w-3.5 h-3.5 border-[var(--color-border-hi)]" />
        <div className="absolute bottom-2 right-2 border-b border-r w-3.5 h-3.5 border-[var(--color-border-hi)]" />
      </div>
